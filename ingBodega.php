...
?>
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Entrada a Bodega</li>
          </ol>
  ...
  <div class="row">
    <div class="col-sm-6">
      ...
      <div class="col-sm-6">
      <div class="pull-right">
        <button id="nuevo" name="nuevo" class="btn btn-primary" title="Crear Entrada a Bodega" onclick="readRecords()"><i class="fas fa-sign-in-alt"></i></button>
          <button id="crea" name="crea" class="btn btn-info" title="Guardar Entrada a Bodega" onclick="saveRecords()"><i class="fas fa-save"></i></button>
          <button id="confirm" name="confirm" class="btn btn-success" title="Confirmar Entrada a Bodega" onclick="ConfirmRecords()"><i class="fas fa-clipboard-check"></i></button>
      </div>
    </div>
  </div>
  <br>
...
<table id="data"  class="table table-striped table-responsive">
    ...
    <script src="class/ingBodega.js"></script>
  </body>
