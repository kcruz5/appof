...
?>
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Tipo Orden de Compra</li>
          </ol>
  ...
  <div class="row">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">                
                <h4 class="modal-title">Agregar Tipo Orden de Compra</h4>
                           <button class="close" type="button" data-dismiss="modal" aria-label="Cerrar">
              <span aria-hidden="true">×</span>
            </button>
            </div>
            <div class="modal-body">
                  <div class="form-group">
                    ...
                    <input type="text" value="" class="form-control" id="descripcion" name="descripcion"/>
                  </div>
                  <div class="form-group">
                    <label for="precio" class="control-label">Muestra precio:</label>
                      <select class="form-control" id="precio" name="precio"><option value="1">Si</option><option value="0">No</option></select>
                  </div>                
            </div>
            <div class="modal-footer">
    ...
    <div class="modal" id="update_modal" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">                
                <h4 class="modal-title">Editar Tipo Orden de Compra</h4>
                           <button class="close" type="button" data-dismiss="modal" aria-label="Cerrar">
              <span aria-hidden="true">×</span>
            </button>
            </div>
            <div class="modal-body">
                  <div class="form-group">
                    <label for="descripcion" class="control-label">Descripción:</label>
                    <input type="text" class="form-control" id="update_descripcion" name="update_descripcion" value=""/>
                  </div>
                  <div class="form-group">
                    <label for="precio" class="control-label">Muestra precio:</label>
                      <select class="form-control" id="update_precio" name="update_precio"><option value="1">Si</option><option value="0">No</option></select>
                  </div>   
...
<script src="//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
      <script src="class/catTipoOc.js"></script>
  </body>
