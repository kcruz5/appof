        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="#">Reporte de Movimientos de Inventario</a>
            </li>
          </ol>
          ...
          <div class="row">
            <div class="col-sm-3">
              <div class="pull-right">
                      ...
                      <label for="mes">Mes/Año:&nbsp;</label><input type="text" id="mes" >
            
              </div>
            </div><br><br> <div class="col-sm-3">
      <div class="pull-right">
          <div class="input-group">							 
								<label for="bodega">Bodega:&nbsp;</label><select class="form-control"  id="bodega" name="bodega" title="Bodega">
              ...
              <div class="pull-right">
                  <div class="search-box">
                      <div class="input-group">								
                          <button class="btn btn-success" onclick="reporte()" title="Generar Reporte"><i class="fas fa-chart-line"></i></button>     <button type="button" class="btn btn-warning" onclick="HTMLtoPDF()" title="Imprimir"><i class="fas fa-print"></i></button>
                      </div>
                 </div>
              </div>
            </div>
...
<script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.11.3/jquery-ui.min.js"></script>      
    ...
    <script src="class/rptMov.js"></script>
...
<script>
$('#mes').monthpicker({pattern: 'mm/yyyy', 
    selectedYear: 2020,
    startYear: 2019,
    finalYear: 2050,});
	var options = {
