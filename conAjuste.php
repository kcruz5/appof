...
<table id="data"  class="table table-striped table-responsive">
  ...
  <br>
                      <div class="col-sm-2">
      <div class="pull-right">
                      <button id="confirm" name="confirm" class="btn btn-success btn-sm" title="Actualizar Captura de Inventario" onclick="ConfirmRecords()"><i class="fas fa-clipboard-check"></i></button>
...
<script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.11.3/jquery-ui.min.js"></script>      
    <script src="components/js/jquery.mtz.monthpicker.js"></script>
      <script src="class/conAjuste.js"></script>
  </body>
