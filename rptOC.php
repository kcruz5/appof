...
(select count(*) from in_ajuste_enc where estado=1) as notificacion";
    ...
    function estado(){
        include("action/keyaction.php");
        $str= "select idinEstadoOC,descripcion from in_estado_oc";
		$resultset = mysqli_query($con, $str) or die("Error de base de datos:". mysqli_error($con));
		while (	$row = mysqli_fetch_array($resultset, MYSQLI_ASSOC)) {
            echo "<option value='".$row["idinEstadoOC"]."'>".$row["descripcion"]."</option>";
	    } 
    }           
}
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="#">Reporte Orden de Compra</a>
            </li>
          </ol>
            ...
            <div class="col-sm-3">
              <div class="pull-right">
                 <div class="input-group">
                      <label for="fecha">Mes/Año:&nbsp;</label><input class="form-control" type="text" id="fecha" >
            </div>
              </div>
            </div><br>   <div class="col-sm-3">
      <div class="pull-right">
          <div class="input-group">			<label for="cliente">Cliente:&nbsp;</label>				 
               ...
               <div class="col-sm-3">
      <div class="pull-right">
          <div class="input-group">		<label for="estado">Estado:&nbsp;</label>					 
								<select class="form-control"  id="estado" name="estado" title="Estado">
                                <option value='0'>Todos los estados</option>
                                    <?php $db = new clsMenu(); $db->estado();?>
                                </select>
							</div>
      </div> </div><br> <div class="col-sm-2">
      <div class="pull-right">
          <div class="input-group">			<label for="oc">No. OC:&nbsp;</label>					 
								<input type="text" value="" class="form-control" id="oc" name="oc" title="Orden de Compra"/>
							</div>
      </div> </div>
          ...
          <br><div id="HTMLtoPDF">
            <div class="row">
                <div class="col-md-12">	 
                     <h4 id="titulo">Reporte Ordenes de Compra</h4>
                    <div id="records_content"></div></div>
                </div>
            </div>
        </div>
...
<script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.11.3/jquery-ui.min.js"></script>      
    ...
    <script src="class/rptOC.js"></script>
  </body>
