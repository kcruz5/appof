<?php
    ...
    function tipocte(){
             include("action/keyaction.php");
        $str= "select idinTipoCte, descripcion from in_tipo_cte where estado=1";
		$resultset = mysqli_query($con, $str) or die("Error de base de datos:". mysqli_error($con));
		while (	$row = mysqli_fetch_array($resultset, MYSQLI_ASSOC)) {
            echo "<option value='".$row["idinTipoCte"]."'>".$row["descripcion"]."</option>";
	    } 
    }
...
<html>
  ...
  <body id="page-top" onload="nobackbutton();">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="contacto" class="control-label">Nombre del Contacto:</label>
                    <input type="text" value="" class="form-control" id="contacto" name="contacto"/>
                  </div> 
                 <div class="form-group">
                    <label for="tipo" class="control-label">Tipo de Cliente:</label>
                     <select class="form-control" id="tipo" name="tipo">
                           <?php  $db = new clsMenu(); $db->tipocte();?>
                         </select>
                  </div>  
                <div class="form-group">
                    <label for="limite" class="control-label">Límite de Crédito:</label>
                    <input type="text" value="0.00" class="form-control" id="limite" name="limite"/>
                  </div>  
            </div>
            <div class="modal-footer">
    ...
    <div class="modal" id="update_modal" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="contacto" class="control-label">Nombre del Contacto:</label>
                    <input type="text" value="" class="form-control" id="update_contacto" name="update_contacto"/>
                  </div> 
                 <div class="form-group">
                    <label for="tipo" class="control-label">Tipo de Cliente:</label>
                     <select class="form-control" id="update_tipo" name="update_tipo">
                           <?php  $db = new clsMenu(); $db->tipocte();?>
                         </select>
                  </div>  
                <div class="form-group">
                    <label for="limite" class="control-label">Límite de Crédito:</label>
                    <input type="text" value="0.00" class="form-control" id="update_limite" name="update_limite"/>
                  </div>  
    ...
    <script src="class/mantCte.js"></script>
  </body>
