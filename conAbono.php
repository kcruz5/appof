      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Abono a OC</li>
          </ol>
  ...
  <div class="row">
       <div class="col-sm-3">
              <div class="pull-right"><div class="input-group">
                  ...
                  <button class="btn btn-success" onclick="reporte()" title="Consultar"><i class="fas fa-chart-line"></i></button>  </div>
              </div>
            </div>
                </div><div class="row">
    <div class="col-md-12">	
      <div id="records_content">
                ...
                <div class="col-md-12">	 <div id="encabezado"></div></div>
                <div class="col-md-12">	
                    <div id="detalle"></div>
                </div>
                <br> <div class="col-md-12">	 
                      <div class="input-group">								
                          <button class="btn btn-danger" onclick="exit()" title="Cerrar Detalle"><i class="fas fa-chevron-circle-left"></i></button>
                </div></div>
            </div> 		
...
<script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.11.3/jquery-ui.min.js"></script>             
    <script src="components/js/jquery.mtz.monthpicker.js"></script>
      <script src="class/conAbono.js"></script>
  </body>
