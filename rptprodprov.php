...
?>
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="#">Reporte Producto Proveedor</a>
            </li>
          </ol>
    ...
    <div class="col-sm-3">
      <div class="pull-right">
          <div class="input-group">							 
								<select class="form-control"  id="proveedor" name="proveedor" title="Proveedor">
      ...
      <div class="pull-right">
          <div class="input-group">							 
								<select class="form-control"  id="producto" name="producto" title="Producto">
          ...
          <br>
            <div class="row"><div id="HTMLtoPDF">
                <div class="col-md-12">	
                    <h4 id="titulo">Reporte Producto Proveedor</h4>
    ...
    <script src="class/rptProdProv.js"></script>
