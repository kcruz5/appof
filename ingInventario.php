...
?>
  ...
  <div class="row">
    <div class="col-sm-6">
      ...
      <div class="col-sm-6">
      <div class="pull-right">
        <button id="nuevo" name="nuevo" class="btn btn-primary" title="Crear Inventario" onclick="readRecords()"><i class="fas fa-sign-in-alt"></i></button>
          <button id="crea" name="crea" class="btn btn-info" title="Guardar Inventario" onclick="saveRecords()"><i class="fas fa-save"></i></button>
          <button id="confirm" name="confirm" class="btn btn-success" title="Confirmar Inventario" onclick="ConfirmRecords()"><i class="fas fa-clipboard-check"></i></button>
      </div>
    </div>
  </div>
  <br>
...
<table id="data"  class="table table-striped table-responsive">
    ...
    <script src="class/ingInventario.js"></script>
  </body>
