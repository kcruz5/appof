        ...
        <div class="container-fluid">
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="main.php">Consultas</a>
            </li>
            <li class="breadcrumb-item active">Salidas por Desperdicio</li>
          </ol>
              ...
              <div class="pull-right">
                 <div class="input-group">
                      <label for="mes">Mes/Año:&nbsp;</label><input type="text" id="mes" >						
                        &nbsp;  <button class="btn btn-success btn-sm" onclick="reporte()" title="Consultar"><i class="fas fa-search-plus"></i></button>
                      </div>
              </div>
            </div>
    <div class="col-md-12">
<table id="data"  class="table table-striped table-responsive">
  ...
  <br>
                      <div class="col-sm-2">
      <div class="pull-right">
                      <button id="confirm" name="confirm" class="btn btn-success btn-sm" title="Actualizar Salida por Desperdicio" onclick="ConfirmRecords()"><i class="fas fa-clipboard-check"></i></button>
...
<script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.11.3/jquery-ui.min.js"></script>      
    <script src="components/js/jquery.mtz.monthpicker.js"></script>
      <script src="class/conDesp.js"></script>
  </body>
