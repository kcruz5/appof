<?php
    ...
    function pais(){
        include("action/keyaction.php");
        $str= "select idcPais, descripcion from c_pais where estado=1";
		$resultset = mysqli_query($con, $str) or die("Error de base de datos:". mysqli_error($con));
		while (	$row = mysqli_fetch_array($resultset, MYSQLI_ASSOC)) {
            echo "<option value='".$row["idcPais"]."'>".$row["descripcion"]."</option>";
	    } 
    }
    function depto(){
            include("action/keyaction.php");
        $str= "select idcdepto, descripcion from c_departamento where idcpais=1 and estado=1";
		$resultset = mysqli_query($con, $str) or die("Error de base de datos:". mysqli_error($con));
		while (	$row = mysqli_fetch_array($resultset, MYSQLI_ASSOC)) {
            echo "<option value='".$row["idcdepto"]."'>".$row["descripcion"]."</option>";
	    } 
    }
...
?>
        ...
        <div class="container-fluid">
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="main.php">Bodegas</a>
            </li>
            <li class="breadcrumb-item active">Mantenimiento de Bodega</li>
          </ol>
  ...
  <div class="row">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="" class="form-control" id="direccion" name="direccion"/>
                  </div>
                     <div class="form-group">
                    <label for="encargado" class="control-label">Encargado:</label>
                    <input type="text" value="" class="form-control" id="encargado" name="encargado"/>
                  </div>
                    <div class="form-group">
                    <label for="telefono" class="control-label">Teléfono:</label>
                    <input type="text" value="" class="form-control" id="telefono" name="telefono"/>
                  </div>
                    <div class="form-group">
                    <label for="correo" class="control-label">Correo:</label>
                    <input type="text" value="" class="form-control" id="correo" name="correo"/>
                  </div>
                  <div class="form-group">                      
                    <label for="pais" class="control-label">País:</label>
                      <select class="form-control" id="pais" name="pais">
                        <?php $db = new clsMenu(); $db->pais();?>
                      </select>
                  </div>                
                <div class="form-group">
                    <label for="depto" class="control-label">Departamento:</label>
                      <select class="form-control" id="depto" name="depto" onchange="cargaMuni()">
                           <?php $db = new clsMenu(); $db->depto();?>
                      </select>
                  </div>
                <div class="form-group">
                    <label for="muni" class="control-label">Municipio:</label>
    ...
    <div class="modal" id="update_modal" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="direccion" class="control-label">Dirección:</label>
                    <input type="text" value="" class="form-control" id="update_direccion" name="update_direccion"/>
                  </div>
                     <div class="form-group">
                    <label for="encargado" class="control-label">Encargado:</label>
                    <input type="text" value="" class="form-control" id="update_encargado" name="update_encargado"/>
                  </div>
                    <div class="form-group">
                    <label for="telefono" class="control-label">Teléfono:</label>
                    <input type="text" value="" class="form-control" id="update_telefono" name="update_telefono"/>
                  </div>
                    <div class="form-group">
                    <label for="correo" class="control-label">Correo:</label>
                    <input type="text" value="" class="form-control" id="update_correo" name="update_correo"/>
                  </div>
                  <div class="form-group">                      
                    <label for="pais" class="control-label">País:</label>
                      <select class="form-control" id="update_pais" name="update_pais">
                        <?php $db = new clsMenu(); $db->pais();?>
                      </select>
                  </div>                
                <div class="form-group">
                    <label for="depto" class="control-label">Departamento:</label>
                      <select class="form-control" id="update_depto" name="update_depto" onchange="cargaMuniUpdate()">
                           <?php $db = new clsMenu(); $db->depto();?>
                      </select>
                  </div>
                <div class="form-group">
                    <label for="muni" class="control-label">Municipio:</label>
                      <select class="form-control" id="update_muni" name="update_muni">
                      </select>
                  </div>
            </div>
            <div class="modal-footer">
    ...
    <script src="class/mantbodega.js"></script>
  </body>
