...
if(isset($_POST['bodega']) && isset($_POST['bodega']) != "")
{
    ...
    $bodega = $_POST['bodega'];
	$query = "select ipb.idinbodega, ipb.idinProd, ip.idinprodcat, ipc.nombre as categoria, ip.nombre as producto, '' as cantidad, ipu.um_descripcion as unidad  from in_prod_bodega ipb
