<?php
    ...
    function producto(){
        include("action/keyaction.php");
        $str= "select idinProd, nombre from in_producto where estado=1";
		$resultset = mysqli_query($con, $str) or die("Error de base de datos:". mysqli_error($con));
		while (	$row = mysqli_fetch_array($resultset, MYSQLI_ASSOC)) {
            echo "<option value='".$row["idinProd"]."'>".$row["nombre"]."</option>";
	    } 
    }   
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Asignación de Productos a Bodega</li>
          </ol>
      ...
      <div class="pull-left">
            <div class="">
							<div class="input-group">							 
								<select class="form-control"  id="cbbod" name="cbbod" onchange="cargaProducto()">
...
<p></p>
  <div class="row">
    <div class="col-sm-6">
      ...
      <div class="col-sm-6">
      <div class="pull-left">
        <button class="btn btn-success" data-toggle="modal" data-target="#add_modal" title="Asignar Producto"><i class="fas fa-list-alt"></i></button>
      </div>
    </div>
  </div>
  <br>
  <div class="row">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">                
                <h4 class="modal-title">Asignar Productos a Bodega</h4>
                           <button class="close" type="button" data-dismiss="modal" aria-label="Cerrar">
              <span aria-hidden="true">×</span>
            </button>
            </div>
            <div class="modal-body">
				<div class="input-group" >							
					<select class="form-control" id="producto" name="producto">
                        ...
                        <?php $db = new clsMenu(); $db->producto();?>
                    </select>
				</div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                <button type="button" id="btn_add" class="btn btn-primary" onclick="addRecord();"><i class="fas fa-check-square"></i> Asignar</button>
            </div>
        </div>
    </div>
</div>
    ...
    <script src="class/prodbod.js"></script>
  </body>
