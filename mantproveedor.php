...
<html>
  ...
  <body id="page-top" onload="nobackbutton();">
        ...
        <div class="container-fluid">
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="#">Mantenimiento Proveedor</a>
            </li>
          </ol> 
    ...
    <div class="modal" id="update_modal" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                  <div class="form-group">
                    <label for="nombre" class="control-label">Nombre:</label>
                    <input type="text" class="form-control" id="update_nombre" name="update_nombre" value=""/>
                  </div>
                <div class="form-group">
                    <label for="direccion" class="control-label">Dirección:</label>
                ...
                <div class="form-group">
                    <label for="correo" class="control-label">Correo:</label>
                    <input type="email" value="" class="form-control" id="update_correo" name="update_correo"/>
                  </div>  
    ...
    <script src="class/mantproveedor.js"></script>
  </body>
