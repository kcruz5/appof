<?php
    ...
    function perfil(){
        include("action/keyaction.php");
        $str= "select idcPerfil, descripcion from c_perfil where estado=1";
		$resultset = mysqli_query($con, $str) or die("Error de base de datos:". mysqli_error($con));
		while (	$row = mysqli_fetch_array($resultset, MYSQLI_ASSOC)) {
            echo "<option value='".$row["idcPerfil"]."'>".$row["descripcion"]."</option>";
	    } 
    }   
...
<html>
  ...
  <body id="page-top" onload="nobackbutton();">
        ...
        <div class="container-fluid">
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="#">Mantenimiento Usuario</a>
            </li>
          </ol> 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" value="" class="form-control" id="usuario" name="usuario"/>
                  </div>                
                  <div class="form-group">
                ...
                <div class="form-group">
                    <label for="confirm" class="control-label">Confirma Contrase&#xF1;a:</label>
                    <input type="password" value="" class="form-control" id="confirm" name="confirm"/>
                </div>    
                  <div class="form-group">                  
                    <label for="perfil" class="control-label">Perfil:</label>
                      <select class="form-control" id="perfil" name="perfil">
                        <?php $db = new clsMenu(); $db->perfil();?>
                      </select>
                  </div>   
            </div>
            <div class="modal-footer">
    ...
    <div class="modal" id="update_modal" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    <label for="usuario" class="control-label">Usuario:</label>
                    <input type="text" value="" class="form-control" id="update_usuario" name="update_usuario" />
                  </div>                
                  <div class="form-group">
                    <label for="password" class="control-label">Contrase&#xF1;a:</label>
                    <input type="password" value="" class="form-control" id="update_password" name="update_password"/>
                  </div>  
                <div class="form-group">
                    <label for="confirm" class="control-label">Confirma Contrase&#xF1;a:</label>
                    <input type="password" value="" class="form-control" id="update_confirm" name="update_confirm"/>
                </div>    
                  <div class="form-group">                  
                    <label for="perfil" class="control-label">Perfil:</label>
                      <select class="form-control" id="update_perfil" name="update_perfil">
                        <?php $db = new clsMenu(); $db->perfil();?>
                      </select>
                  </div>   
            </div>
    ...
    <script src="class/mantUsuario.js"></script>
  </body>
