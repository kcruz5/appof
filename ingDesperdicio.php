...
?>
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Salida por Desperdicio</li>
          </ol>
  ...
  <div class="row">
    <div class="col-sm-6">
      ...
      <div class="col-sm-6">
      <div class="pull-right">
        <button id="nuevo" name="nuevo" class="btn btn-primary" title="Crear Salida por Desperdicio" onclick="readRecords()"><i class="fas fa-sign-in-alt"></i></button>
          <button id="crea" name="crea" class="btn btn-info" title="Guardar Salida por Desperdicio" onclick="saveRecords()"><i class="fas fa-save"></i></button>
          <button id="confirm" name="confirm" class="btn btn-success" title="Confirmar Salida por Desperdicio" onclick="ConfirmRecords()"><i class="fas fa-clipboard-check"></i></button>
      </div>
    </div>
  </div>
  <br>
...
<table id="data"  class="table table-striped table-responsive">
    ...
    <script src="class/ingDesperdicio.js"></script>
  </body>
